  ...
  Game.prototype.tryDoOnReady = function () {
    ...
    if (this.isReady() && this.onReadyPending) {
      ...
      if (this.onReadyCallbacks.length) {
        try {
          for (
            var _b = __values(this.onReadyCallbacks), _c = _b.next();
            !_c.done;
            _c = _b.next()
          ) {
...
var Sprite = (function () {
  function Sprite(stage, layer, costumePaths, soundPaths) {
    ...
    if (costumePaths === void 0) {
      costumePaths = [];
    }
    if (soundPaths === void 0) {
      soundPaths = [];
    }
    this.name = "No name";
    this.size = 100;
    ...
    if (!Registry.getInstance().has("game")) {
      this.game.throwError(
        "You need create Game instance before Sprite instance."
      );
    }
    ...
    if (!this.stage) {
      this.game.throwError(
        "You need create Stage instance before Sprite instance."
      );
    }
    this._layer = layer;
    ...
    try {
      for (
        var costumePaths_1 = __values(costumePaths),
          costumePaths_1_1 = costumePaths_1.next();
        !costumePaths_1_1.done;
        costumePaths_1_1 = costumePaths_1.next()
      ) {
      ...
      try {
        if (
          costumePaths_1_1 &&
          !costumePaths_1_1.done &&
          (_a = costumePaths_1.return)
        )
          _a.call(costumePaths_1);
      } finally {
    ...
    try {
      for (
        var soundPaths_1 = __values(soundPaths),
          soundPaths_1_1 = soundPaths_1.next();
        !soundPaths_1_1.done;
        soundPaths_1_1 = soundPaths_1.next()
      ) {
      ...
      try {
        if (
          soundPaths_1_1 &&
          !soundPaths_1_1.done &&
          (_b = soundPaths_1.return)
        )
          _b.call(soundPaths_1);
      } finally {
  ...
  Sprite.prototype.isReady = function () {
    return (
      this.loadedCostumes == this.costumes.length &&
      this.loadedSounds == this.sounds.length
    );
  };
  Sprite.prototype.onReady = function (callback) {
    this.onReadyCallbacks.push(callback);
  };
  Sprite.prototype.addCostume = function (
    costumePath,
    name,
    x,
    y,
    ...
    image.addEventListener("error", function () {
      _this.game.throwError(
        'Costume image "' +
          costumePath +
          '" was not loaded. Check that the path is correct.'
      );
    });
  };
  ...
  Sprite.prototype.addCostumeByImage = function (
    costume,
    image,
    x,
    y,
    ...
    costume.body = new Polygon(this.x, this.y, [
      [
        (costume.width / 2) * -1 + paddingLeft * -1,
        (costume.height / 2) * -1 + paddingTop * -1,
      ],
      [
        costume.width / 2 + paddingRight,
        (costume.height / 2) * -1 + paddingTop * -1,
      ],
      [costume.width / 2 + paddingRight, costume.height / 2 + paddingBottom],
      [
        (costume.width / 2) * -1 + paddingLeft * -1,
        costume.height / 2 + paddingBottom,
      ],
    ]);
    costume.ready = true;
  ...
  Sprite.prototype.addCostumes = function (
    costumePath,
    name,
    cols,
    rows,
  ...
  Sprite.prototype.switchCostume = function (costumeIndex) {
    ...
    if (costume instanceof Costume && costume.ready) {
      ...
      if (this.singleBody) {
        ...
        costume.image.addEventListener(
          "load",
          function () {
  ...
  Sprite.prototype.touchSprites = function (sprites, result) {
    ...
    try {
      for (
        var sprites_1 = __values(sprites), sprites_1_1 = sprites_1.next();
        !sprites_1_1.done;
        sprites_1_1 = sprites_1.next()
      ) {
      ...
      try {
        if (sprites_1_1 && !sprites_1_1.done && (_a = sprites_1.return))
          _a.call(sprites_1);
      } finally {
  ...
  Sprite.prototype.touchPotentialSprites = function (sprites, result) {
    ...
    try {
      for (
        var sprites_2 = __values(sprites), sprites_2_1 = sprites_2.next();
        !sprites_2_1.done;
        sprites_2_1 = sprites_2.next()
      ) {
      ...
      try {
        if (sprites_2_1 && !sprites_2_1.done && (_a = sprites_2.return))
          _a.call(sprites_2);
      } finally {
    ...
    try {
      for (
        var potentialSprites_1 = __values(potentialSprites),
          potentialSprites_1_1 = potentialSprites_1.next();
        !potentialSprites_1_1.done;
        potentialSprites_1_1 = potentialSprites_1.next()
      ) {
      ...
      try {
        if (
          potentialSprites_1_1 &&
          !potentialSprites_1_1.done &&
          (_b = potentialSprites_1.return)
        )
          _b.call(potentialSprites_1);
      } finally {
  ...
  Sprite.prototype.pointForward = function (sprite) {
    this.direction =
      (Math.atan2(this.y - sprite.y, this.x - sprite.x) / Math.PI) * 180 - 90;
  };
  ...
  Sprite.prototype.createClone = function (stage) {
    ...
    try {
      for (
        var _c = __values(this.costumes), _d = _c.next();
        !_d.done;
        _d = _c.next()
      ) {
    ...
    try {
      for (
        var _e = __values(this.sounds.entries()), _f = _e.next();
        !_f.done;
        _f = _e.next()
      ) {
  ...
  Sprite.prototype.forever = function (callback, timeout) {
    ...
    if (timeout) {
      setTimeout(function () {
        requestAnimationFrame(function () {
          return _this.forever(callback, timeout);
        });
      }, timeout);
    } else {
      requestAnimationFrame(function () {
        return _this.forever(callback);
      });
    }
  };
  ...
  Sprite.prototype.addListeners = function () {
    ...
    document.addEventListener(SPRITE_COSTUME_READY_EVENT, function (event) {
      if (_this.id == event.detail.spriteId) {
        ...
        _this.tryDoOnReady();
        if (
          _this.loadedCostumes == _this.costumes.length &&
          _this.costume === null
        ) {
...
var Stage = (function () {
  function Stage(background, padding) {
    ...
    if (!Registry.getInstance().has("game")) {
      this.game.throwError(
        "You need create Game instance before Stage instance."
      );
    }
    this.game = Registry.getInstance().get("game");
  ...
  Object.defineProperty(Stage.prototype, "padding", {
    ...
    set: function (padding) {
      ...
      this.topEdge = this.collisionSystem.createPolygon(0, 0, [
        [padding, padding],
        [this.width - padding, padding],
      ]);
      this.rightEdge = this.collisionSystem.createPolygon(0, 0, [
        [this.width - padding, padding],
        [this.width - padding, this.height - padding],
      ]);
      this.bottomEdge = this.collisionSystem.createPolygon(0, 0, [
        [this.width - padding, this.height - padding],
        [padding, this.height - padding],
      ]);
      this.leftEdge = this.collisionSystem.createPolygon(0, 0, [
        [padding, this.height - padding],
        [padding, padding],
      ]);
    },
  ...
  Stage.prototype.removeSprite = function (sprite) {
    if (!this.sprites.has(sprite.layer)) {
      this.game.throwError(
        'The layer "' + sprite.layer + '" not defined in the stage.'
      );
    }
  ...
  Stage.prototype.render = function () {
    ...
    var layers = Array.from(this.sprites.keys()).concat(
      Array.from(this.drawings.keys())
    );
    ...
    try {
      for (
        var layers_1 = __values(layers), layers_1_1 = layers_1.next();
        !layers_1_1.done;
        ...
        if (this.drawings.has(layer)) {
          ...
          try {
            for (
              var layerDrawings_1 = ((e_11 = void 0), __values(layerDrawings)),
                layerDrawings_1_1 = layerDrawings_1.next();
              !layerDrawings_1_1.done;
              layerDrawings_1_1 = layerDrawings_1.next()
            ) {
            ...
            try {
              if (
                layerDrawings_1_1 &&
                !layerDrawings_1_1.done &&
                (_b = layerDrawings_1.return)
              )
                _b.call(layerDrawings_1);
            } finally {
        ...
        if (this.sprites.has(layer)) {
          ...
          var _loop_1 = function (sprite) {
            ...
            if (this_1.game.debugMode !== "none") {
              var fn = function () {
                var x =
                  sprite.x - _this.context.measureText(sprite.name).width / 2;
          ...
          try {
            for (
              var layerSprites_1 = ((e_12 = void 0), __values(layerSprites)),
                layerSprites_1_1 = layerSprites_1.next();
              !layerSprites_1_1.done;
              layerSprites_1_1 = layerSprites_1.next()
            ) {
            ...
            try {
              if (
                layerSprites_1_1 &&
                !layerSprites_1_1.done &&
                (_c = layerSprites_1.return)
              )
                _c.call(layerSprites_1);
            } finally {
  ...
  Stage.prototype.isReady = function () {
    return (
      this.addedSprites == this.loadedSprites &&
      this.loadedBackgrounds == this.backgrounds.length
    );
  };
  Stage.prototype.run = function () {
    ...
    try {
      for (
        var _c = __values(this.sprites.values()), _d = _c.next();
        !_d.done;
        _d = _c.next()
      ) {
        ...
        try {
          for (
            var layerSprites_2 = ((e_14 = void 0), __values(layerSprites)),
              layerSprites_2_1 = layerSprites_2.next();
            !layerSprites_2_1.done;
            layerSprites_2_1 = layerSprites_2.next()
          ) {
          ...
          try {
            if (
              layerSprites_2_1 &&
              !layerSprites_2_1.done &&
              (_b = layerSprites_2.return)
            )
              _b.call(layerSprites_2);
          } finally {
  ...
  Stage.prototype.stop = function () {
    ...
    try {
      for (
        ...
        try {
          for (
            var layerSprites_3 = ((e_16 = void 0), __values(layerSprites)),
              layerSprites_3_1 = layerSprites_3.next();
            !layerSprites_3_1.done;
            layerSprites_3_1 = layerSprites_3.next()
          ) {
          ...
          try {
            if (
              layerSprites_3_1 &&
              !layerSprites_3_1.done &&
              (_b = layerSprites_3.return)
            )
              _b.call(layerSprites_3);
          } finally {
  ...
  Stage.prototype.addListeners = function () {
    ...
    document.addEventListener(STAGE_BACKGROUND_READY_EVENT, function (event) {
      if (_this.id == event.detail.stageId) {
        ...
        _this.tryDoRun();
        if (
          _this.loadedBackgrounds == _this.backgrounds.length &&
          _this.backgroundIndex === null
        ) {
  ...
  Stage.prototype.doOnStart = function () {
    ...
    try {
      for (
        var _b = __values(this.onStartCallbacks), _c = _b.next();
        !_c.done;
        _c = _b.next()
      ) {
        var callback = _c.value;
...
var CollisionSystem = (function () {
  ...
  CollisionSystem.prototype.createCircle = function (
    x,
    y,
    radius,
    scale,
  ...
  CollisionSystem.prototype.createPolygon = function (
    x,
    y,
    points,
    angle,
  ...
  CollisionSystem.prototype.insert = function () {
    ...
    try {
      for (
        var bodies_1 = __values(bodies), bodies_1_1 = bodies_1.next();
        !bodies_1_1.done;
        bodies_1_1 = bodies_1.next()
      ) {
      ...
      try {
        if (bodies_1_1 && !bodies_1_1.done && (_a = bodies_1.return))
          _a.call(bodies_1);
      } finally {
  ...
  CollisionSystem.prototype.remove = function () {
    ...
    try {
      for (
        var bodies_2 = __values(bodies), bodies_2_1 = bodies_2.next();
        !bodies_2_1.done;
        bodies_2_1 = bodies_2.next()
      ) {
      ...
      try {
        if (bodies_2_1 && !bodies_2_1.done && (_a = bodies_2.return))
          _a.call(bodies_2);
      } finally {
